...
use App\Filament\Company\Resources\Hr\SalaryPartResource\Pages;
use App\Filament\Company\Resources\Hr\SalaryPartResource\RelationManagers;
                    ...
                    ->schema([
                        ...
                        Forms\Components\Select::make('basis')
                            ...
                            ->disabled(function ($record, $get) {
                                // Check if record is being edited and type is BaseSalary, disable basis
